...
public class AshClayBlocks {
    public static final AshClayBlock ASH_CLAY = new AshClayBlock(AbstractBlock.Settings.of(Material.SUPPORTED).sounds(BlockSoundGroup.GRAVEL).breakInstantly());
    public static final AshClayBrickBlock ASH_CLAY_BRICK = new AshClayBrickBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly());
    ...
    public static void register() {
        ...
        Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("ash_clay", "ash_clay_furnace"), ASH_CLAY_FURNACE_BLOCK_ENTITY_TYPE);
    }
}
